...
export const UserDetails=({data}:UserProps)=>{
    ...
    const [info,setInfo]=useState<UserDetailsInterface>(data)
    ...
    const formHandler = (formValues:UserDetailsInterface) => {
        ...
        setInfo({...data,bio,phoneNumber,firstName,lastName})
         ...
         <div className="flex text-light-primary-text flex-col h-fit w-full text-light-primary-text max-w-xs p-4 shadow-md px-12 bg-secondary-background">
             ...
             <div className="space-y-4 text-center">
                 <div className="my-2 space-y-1">
                     <h2 className="text-xl font-semibold sm:text-2xl">{data.firstName} {data.lastName}</h2>
