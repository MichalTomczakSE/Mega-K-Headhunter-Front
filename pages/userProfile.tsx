...
const UserProfile=()=>{
    return (
        <div>
            <Header/>
            <div className={"flex justify-center w-screen h-auto sm:h-full sm:flex-row flex-col  pt-5  bg-primary-background space-y-2 sm:space-y-0 space-x-0 sm:space-x-2"}>
                <GoBack/>
                <div className={"sm:h-screen w-96 flex justify-center"}>
